# Portafilio Profesional guide installation
...
activate portafilio_profesional
```
...
To move beyond notebook prototyping, all reusable code should go into the `portafilio_profesional/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `portafilio_profesional` folder and use the modules inside your notebooks :
...
```python
from portafilio_profesional.utils.paths import data_dir
data_dir()
```
